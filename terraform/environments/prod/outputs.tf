...
output "app_config" {
  ...
  value = {
    ...
    # AWS_REGION. Without it the IRSA credential provider calls the global
    # sts.amazonaws.com, which this VPC cannot reach, and the first AWS call
